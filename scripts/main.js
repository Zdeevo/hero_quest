import heroText from './Data/text.js'

//Convenience variable 
const t = heroText

console.log(t.intro1)
...
switch (btnClick) {
  ...
  case ('btn12'): 
    ...
    break;
  case ('btn13'): 
    textElement.innerHTML = t.story14;
   // hide buttons  
   ...
   option2ButtonElement.style.display = "none";
    break;
  case ('btn14'): 
    textElement.innerHTML = t.story15;
    // hide buttons  
    option1ButtonElement.innerHTML = t.restart;
    option1ButtonElement.setAttribute('id', 'restart');
    option2ButtonElement.style.display = "none";
  ...
  case ('btn16'): 
    ...
    break;
  case ('btn17'):
    textElement.innerHTML = t.story18;
    // hide buttons
    option1ButtonElement.innerHTML = t.restart;
    option1ButtonElement.setAttribute('id', 'restart');
    option2ButtonElement.style.display = "none";
    break;
  case ('btn18'): 
    textElement.innerHTML = t.story19;
    // hide buttons
    option1ButtonElement.innerHTML = t.restart;
    option1ButtonElement.setAttribute('id', 'restart');
    option2ButtonElement.style.display = "none";
  ...
  case ('btn19'): 
    ...
    break;
  case ('btn20'): 
    textElement.innerHTML = t.story21;
   // hide buttons
   option1ButtonElement.innerHTML = t.restart;
   option1ButtonElement.setAttribute('id', 'restart');
   option2ButtonElement.style.display = "none";
    break;
  case ('btn21'): 
    textElement.innerHTML = t.story22;
   // hide buttons
   option1ButtonElement.innerHTML = t.restart;
   option1ButtonElement.setAttribute('id', 'restart');
   option2ButtonElement.style.display = "none";
  ...
  case ('btn22'): 
    ...
    break;
  case ('btn23'): 
    textElement.innerHTML = t.story26;
    // hide buttons
    option1ButtonElement.innerHTML = t.restart;
    option1ButtonElement.setAttribute('id', 'restart');
    option2ButtonElement.style.display = "none";
    break;
  case ('btn24'): 
    textElement.innerHTML = t.story27;
    // hide buttons
    option1ButtonElement.innerHTML = t.restart;
    option1ButtonElement.setAttribute('id', 'restart');
    option2ButtonElement.style.display = "none";
    break;
  case ('btn25'): 
    textElement.innerHTML = t.story24;
    // hide buttons 
    option1ButtonElement.innerHTML = t.restart;
    option1ButtonElement.setAttribute('id', 'restart');
    option2ButtonElement.style.display = "none";
