...
var _text = _interopRequireDefault(require("./Data/text.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

//Convenience variable 
var t = _text["default"];
console.log(t.intro1); // setting variables for text and button elements
...
textElement.innerHTML = t.intro1;
option1ButtonElement.innerHTML = t.introButton1;
...
var clickFunction = function clickFunction(clicked_id) {
  ...
  switch (btnClick) {
    ...
    case 'introButton1':
      textElement.innerHTML = t.intro2;
      option1ButtonElement.innerHTML = t.introButton2;
      option2ButtonElement.innerHTML = t.introButton3;
    ...
    case 'introButton2':
      ...
      option1ButtonElement.innerHTML = t.option1;
      option2ButtonElement.innerHTML = t.option2;
    ...
    case 'introButton3':
      textElement.innerHTML = t.intro3;
      option1ButtonElement.style.display = "none";
      option2ButtonElement.style.display = "none";
      break;

    case 'btn1':
      textElement.innerHTML = t.story2;
      option1ButtonElement.innerHTML = t.option3;
      option2ButtonElement.innerHTML = t.option4;
    ...
    case 'btn2':
      textElement.innerHTML = t.story3;
      option1ButtonElement.innerHTML = t.option5;
      option2ButtonElement.innerHTML = t.option6;
    ...
    case 'btn3':
      textElement.innerHTML = t.story4;
      option1ButtonElement.innerHTML = t.option7;
      option2ButtonElement.innerHTML = t.option8;
    ...
    case 'btn4':
      textElement.innerHTML = t.story5;
      option1ButtonElement.innerHTML = t.option9;
      option2ButtonElement.innerHTML = t.option10;
    ...
    case 'btn5':
      textElement.innerHTML = t.story6;
      option1ButtonElement.innerHTML = t.option11;
      option2ButtonElement.innerHTML = t.option12;
    ...
    case 'btn6':
      textElement.innerHTML = t.story7;
      option1ButtonElement.innerHTML = t.option13;
      option2ButtonElement.innerHTML = t.option14;
    ...
    case 'btn7':
      textElement.innerHTML = t.story8;
      option1ButtonElement.innerHTML = t.option15;
      option2ButtonElement.innerHTML = t.option16;
    ...
    case 'btn8':
      textElement.innerHTML = t.story9;
      option1ButtonElement.innerHTML = t.option17;
      option2ButtonElement.innerHTML = t.option18;
    ...
    case 'btn9':
      textElement.innerHTML = t.story10;
      option1ButtonElement.innerHTML = t.option19;
      option2ButtonElement.innerHTML = t.option20;
    ...
    case 'btn10':
      textElement.innerHTML = t.story11;
      option1ButtonElement.innerHTML = t.option15;
      option2ButtonElement.innerHTML = t.option16;
      option1ButtonElement.setAttribute('id', 'btn15');
      option2ButtonElement.style.display = "inline";
    ...
    case 'btn11':
      textElement.innerHTML = t.story12;
      option1ButtonElement.innerHTML = t.option21;
      option2ButtonElement.innerHTML = t.option22;
    ...
    case 'btn12':
      textElement.innerHTML = t.story13;
      option1ButtonElement.innerHTML = t.option13;
      option2ButtonElement.innerHTML = t.option14;
      option1ButtonElement.setAttribute('id', 'btn13');
      option2ButtonElement.style.display = "inline";
    ...
    case 'btn13':
      textElement.innerHTML = t.story14; // hide buttons  

      option1ButtonElement.innerHTML = t.restart;
      option1ButtonElement.setAttribute('id', 'restart');
      option2ButtonElement.style.display = "none";
      break;

    case 'btn14':
      textElement.innerHTML = t.story15; // hide buttons  
    ...
    case 'btn15':
      textElement.innerHTML = t.story16;
      option1ButtonElement.innerHTML = t.option23;
      option2ButtonElement.innerHTML = t.option24;
    ...
    case 'btn16':
      textElement.innerHTML = t.story17;
      option1ButtonElement.innerHTML = t.option23;
      option2ButtonElement.innerHTML = t.option24;
      option1ButtonElement.setAttribute('id', 'btn23');
      option2ButtonElement.style.display = "inline";
    ...
    case 'btn17':
      textElement.innerHTML = t.story18; // hide buttons
    ...
    case 'btn18':
      textElement.innerHTML = t.story19; // hide buttons
    ...
    case 'btn19':
      textElement.innerHTML = t.story20;
      option1ButtonElement.innerHTML = t.option25;
      option2ButtonElement.innerHTML = t.option26;
    ...
    case 'btn20':
      textElement.innerHTML = t.story21; // hide buttons
    ...
    case 'btn21':
      textElement.innerHTML = t.story22; // hide buttons
    ...
    case 'btn22':
      textElement.innerHTML = t.story23;
      option1ButtonElement.innerHTML = t.option13;
      option2ButtonElement.innerHTML = t.option14;
      option1ButtonElement.setAttribute('id', 'btn13');
      option2ButtonElement.style.display = "inline";
    ...
    case 'btn23':
      textElement.innerHTML = t.story26; // hide buttons
    ...
    case 'btn24':
      textElement.innerHTML = t.story27; // hide buttons
    ...
    case 'btn25':
      textElement.innerHTML = t.story24; // hide buttons 
    ...
    case 'btn26':
      textElement.innerHTML = t.story25;
      option1ButtonElement.innerHTML = t.restart;
      option1ButtonElement.setAttribute('id', 'restart');
      option2ButtonElement.style.display = "none";
      break;
